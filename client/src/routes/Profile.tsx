  ...
  return (
    <>
      ...
      <main className="mt-12 mb-22 flex flex-col gap-4 lg:mb-5 lg:ml-57 lg:flex-row lg:items-start lg:justify-center lg:gap-9">
        <ImagesCarousel className="h-[35rem] lg:w-full xl:w-[30rem] xl:shrink-0" />
        <div className="flex flex-col gap-8 lg:w-full xl:w-127">
          ...
          <div className="flex flex-col gap-3">
            <div className="flex items-center gap-3">
              ...
              <span className="text-secondary">Mustapha ouasit</span>
            </div>
            <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col gap-4">
            <div className="flex flex-wrap items-center gap-4">
              <div className="border-grayDark-100 text-grayDark rounded-full border-2 bg-white px-5 py-2">
                Sport
              </div>
              <div className="border-grayDark-100 text-grayDark rounded-full border-2 bg-white px-5 py-2">
                Books
